...
insert into groups(id, group_id, assignment_id, answer, active) values ('3', 'g3', '2022-CS001-001', 'test',  true);
insert into groups(id, group_id, assignment_id, answer, active) values ('4', 'g4', '2022-CS001-001', 'test',  true);