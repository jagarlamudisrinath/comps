...
import org.comps.errors.ResourceNotFoundException;
import org.comps.errors.StorageException;
...
public class FileSystemStorageService implements StorageService {
    ...
    public void init() {
        try {
            ...
            throw new ResourceNotFoundException("Could not initialize storage", e);
        }
    }
}
